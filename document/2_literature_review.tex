...
\cite{valence_and_lyrics}This study investigates the relationship between lyrical features and perceived
...
audio features were dominant in predicting perceived arousal.
...
with an R2 of 0.481}, but lyrics had little impact on arousal models. These
...
\cite{du_2024}This paper investigates the relationship between sentiment and themes in music
...
modeling and Support Vector Machines (SVM) for sentiment classification.
